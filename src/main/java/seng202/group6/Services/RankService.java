...
public class RankService {
     ...
     */
    private static ArrayList<Frequency> rankedList(List<Crime> crimes, Function<Crime, String> function) {
     ...
     */
    public static ArrayList<Frequency> rankedTypeList(List<Crime> crimes) {
     ...
     * @return A sorted array list of Frequencies
     */
    public static ArrayList<Frequency> rankedAreaList(List<Crime> crimes) {
     ...
     * @return A sorted array list of Frequencies
     */
    public static ArrayList<Frequency> rankedTimeList(List<Crime> crimes, TimeType timeType) {
